...
export class DailyreportPage implements OnInit {
  ...
  constructor(public menuCtrl: MenuController,
    ...
    public loadingCtrl: LoadingController, private http: HttpClient, public toastCtrl: ToastController, private platform: Platform, private router: Router, public str: Storage, private file: File, private camera: Camera, private androidPermissions: AndroidPermissions) {
    ...
    this.route.queryParams.subscribe(params => {
      ...
      if (params && params['special']) {
        ...
        this.sealstatus = this.data.sealstatus;
        this.branch=this.data.branchname;
        alert("daily report"+this.branch);
  ...
  readFile(file: any) {
    ...
    formData.append('seal', this.sealstatus);
