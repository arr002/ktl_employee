...
@Component({
  selector: 'app-vanupadddataupload',
  templateUrl: './vanupadddataupload.page.html',
  styleUrls: ['./vanupadddataupload.page.scss'],
  standalone: false,
})
export class VanupadddatauploadPage implements OnInit {
      ...
      //} else {
        ...
        if(this.consumptionDataArr.length != 0) {
          //this.maindata=this.consumptionDataArr;
            ...
            this.brandArr1.push({ "value" : "KTL", "name" : "KTL" });
            this.brands = this.brandArr[0].value;
        } else {
